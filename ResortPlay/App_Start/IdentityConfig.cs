...
namespace ResortPlay
{
    ...
    public class ApplicationUserManager : UserManager<HMS_User>
    {
        public ApplicationUserManager(IUserStore<HMS_User> store)
            : base(store)
        {
        }
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<HMS_User>(context.Get<ResortPlayContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<HMS_User, string>
    {
